...
def create_vpn_config(template1, template2, data_dict):
    vpn1 = generate_config(template1, data_dict)
    vpn2 = generate_config(template2, data_dict)
    output = (vpn1, vpn2)
    return output

if __name__ == "__main__":
    cfg1_file = "templates/gre_ipsec_vpn_1.txt"
    cfg2_file = "templates/gre_ipsec_vpn_2.txt"
    print(create_vpn_config(cfg1_file, cfg2_file, data))